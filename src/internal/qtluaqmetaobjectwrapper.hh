...
namespace QtLua {
	...
	class QTLUA_API QModuleClassWrapper : public QMetaObjectWrapper
	{
	public:
		QTLUA_REFTYPE(QModuleClassWrapper);

		QModuleClassWrapper(const QMetaObject *mo, qobject_creator *creator = 0);
